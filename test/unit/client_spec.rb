...
describe Teleflow::Client do
  ...
  it "failed request not retried" do
    client = Teleflow::Client.new(access_token: access_token)
  ...
  it "performs idempotent request with no duplicate result" do
    ...
    client = Teleflow::Client.new(access_token: access_token, idempotency_key: idempotency_key2)
